...
/* ma_tls_read
   ...
   Returns:
     ...
     -1           if an error occured
*/
size_t ma_tls_read(MARIADB_TLS *ctls, const unsigned char* buffer, size_t length);
...
/* ma_tls_write
   ...
   Returns:
     ...
     -1           if an error occured
*/
size_t ma_tls_write(MARIADB_TLS *ctls, const unsigned char* buffer, size_t length);
...
size_t ma_pvio_tls_read(MARIADB_TLS *ctls, const unsigned char *buffer, size_t length);
size_t ma_pvio_tls_write(MARIADB_TLS *ctls, const unsigned char *buffer, size_t length);
